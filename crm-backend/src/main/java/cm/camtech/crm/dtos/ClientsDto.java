...
public class ClientsDto {
    ...
    public ClientsDto(Long id, String nom, String prenom, String email,
                      String telephone, Date dateNaissance, String adresse,
                      String ville, int pointsFidelite,
                      String niveauFidelite, String statut,
                      Date dateInscription, Date dateModification,
                      Long restaurantHabituelId, Long creeParId) {
